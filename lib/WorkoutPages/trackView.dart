...
class _WorkoutTrackerViewState extends State<WorkoutTrackerView> {
                  ...
                  LineChartData(
                    lineTouchData: LineTouchData(
                            ...
                            FlDotData(
                              ...
                              getDotPainter: (spot, percent, barData, index) =>
                                  FlDotCirclePainter(
                                    ...
                                    color: Colors.white,
                                    strokeWidth: 3,
                                    strokeColor: PageColors.secondaryColor1,
                                  ),
                            ),
                          );
                        }).toList();
                      ...
                      touchTooltipData: LineTouchTooltipData(
                        tooltipBgColor: PageColors.secondaryColor1,
                    ...
                    gridData: FlGridData(
                      ...
                      getDrawingHorizontalLine: (value) {
                        return FlLine(
                          color: PageColors.white.withOpacity(0.15),
                          strokeWidth: 2,
                        );
                      },
                    ),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: PageColors.primaryColor2.withOpacity(0.3),
  ...
  LineChartBarData get lineChartBarData1_2 => LineChartBarData(
    isCurved: true,
    color: PageColors.white.withOpacity(0.5),
    barWidth: 2,
    isStrokeCapRound: true,
    dotData: FlDotData(show: false),
